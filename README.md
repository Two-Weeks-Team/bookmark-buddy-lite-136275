...
> Fast, private web‑page saver – one click, no frills.

---

## Overview

People need a simple, privacy‑first way to capture URLs and recall them later without relying on third‑party services or complex setup.
...
```yaml
name: bookmark-buddy-lite
services:
  - name: api
    github:
      repo: Two-Weeks-Team/bookmark-buddy-lite
      branch: master
